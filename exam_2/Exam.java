...
public class Exam {
    ...
    public static void main(String[] args) throws Exception {
        ...
        sumCharacter(firstName, surName);
        ...
        isLargestNumber(firstNumber, secondNumber, thirdNumber);
        ...
        //input (-) in the case of providing no answer for the specialization.
        ...
        if (studentEmailAddress.contains("rapi") && studentEmailAddress.contains("@student.national-u.edu.ph")) {
            System.out.println("valid");
        }
        else {
            System.out.println("invalid");
        ...
        // I will leave no answer for this item.

        // Close scanner
        scan.close();
    }

    static void findNumberValue(int number) {
        if (number > 0) {
    ...
    static void isPrimeNumber (int lastDigit) {
    ...
    static void sumCharacter (String firstName, String surName) {
        int sumofchar = firstName.length() + surName.length();
        System.out.println("The sum of the character lengths of both firstname and surname is: " + sumofchar);
    }

    static void isLargestNumber (int firstNumber, int secondNumber, int thirdNumber) {
        if (firstNumber > secondNumber && firstNumber > thirdNumber) {
            ...
            System.out.println("The numbers inputted are of the same value.");
        }
    }

    static void isNameVowel(char firstChar) {
